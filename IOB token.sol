...
contract HumanStandardToken is StandardToken {
    ...
    */
    ...
    uint8 public decimals;                //How many decimals to show. ie. 
                                          //There could 1000 base units with 3 decimals. Meaning 0.980 SBX = 980 base units. It's like comparing 1 wei to 1 ether.
    ...
    constructor (
        ...
        totalSupply = _initialAmount;                        // Update total supply = 1,000,000,000
        name = _tokenName;                                   // Set the name for display purposes, set to "IOB Token"
